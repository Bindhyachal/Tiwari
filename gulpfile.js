...
gulp.task("001-YasConnect-Build-Publish", function (callback) {
  return runSequence(
    "Build-Solution",
...
gulp.task("002-YasConnect-RestoreNuget-Build-Publish", function (callback) {
  return runSequence(
    "02-Nuget-Restore",
    "Build-Solution",
    "Publish-Foundation-Projects",
...
gulp.task("003-YasConnect-Sync-Unicorn", function (callback) {
  var options = {};
